...
export interface SATProcessingLog {
  id: string;
  timestamp: string;
  stepName: string;
  stepStatus: 'SUCCESS' | 'FAILED' | 'INFO' | 'WARNING';
  message: string | null;
  details: any | null;
}

export interface SATDocumentListResponse {
  total: number;
