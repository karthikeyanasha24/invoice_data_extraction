...
export default function FailedInvoicePage() {
    ...
    // Save XML to backend file system and redirect to processing page
    const handleSave = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                console.log("✅ XML file saved successfully, redirecting to processing page...");

                // Redirect to upload/processing page to show reprocessing steps
                router.push(`/upload?trackingId=${invoice.tracking_id}&reprocess=true&source=failed`);
            }
                ...
                <div className="max-w-6xl mx-auto h-full">
                    <div className={cn(
                        ...
                        <div className="h-full">
                                                                            ...
                                                                            <div className="bg-white border border-gray-200 rounded-lg p-3 max-h-96 overflow-auto transition-all duration-300 shadow-sm">
                                                                                <div className="flex justify-between items-center mb-2">
                                                                                    ...
                                                                                    <div className="flex space-x-2">
                                                                                        {/* Always show Edit button for failed invoices */}
                                                                                        <button
                            ...
                            {/* XML Editor - Always show for failed invoices with XML content */}
                            {invoice.xml_content && (
                                            ...
                                            <div className="flex justify-between items-center mb-3 pb-3 border-b border-gray-200">
                                                ...
                                                <div className="flex space-x-2 flex-wrap gap-2">
                                                    <button
                                                        onClick={() => setIsEditing(!isEditing)}
                                                        disabled={isSaving}
                                                        className={`text-sm px-3 py-1 rounded transition-colors ${isEditing
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <div className="flex justify-end space-x-2">
                                                        ...
                                                        <button
                                                            ...
                                                            className={`px-4 py-2 rounded-md font-medium transition-colors flex items-center space-x-2 ${isSaving
